...
class AgenciesListControllerJunitTest {
    ...
    void testAgenciesAreRetrievedCorrectlyFromTheDatabase() {
        UserService.addUser("user1","1111","Travel Agent","user1","user1@gmail.com","0711111111","DreamVacation");
        UserService.addUser("user2","2222","Travel Agent","user2","user2@gmail.com","0722222222","BestBooking");
        UserService.addUser("user3","3333","Travel Agent","user3","user3@gmail.com","0733333333","AuthenticVacation");
        UserService.addUser("user4","4444","Travel Agent","user4","user4@gmail.com","0744444444","DreamVacation");
        UserService.addUser("user5","5555","Travel Agent","user5","user5@gmail.com","0755555555","SupremeVacation");
        UserService.addUser("user6","6666","Travel Agent","user6","user6@gmail.com","0766666666","SupremeVacation");
